...
{% callout info %}
{% include callouts/warning-color-assistive-technologies.md %}
{% endcallout %}
...
Similarly, you can use [flexbox utilities]({{ site.docsref "/utilities/flex" }}) and [Bootstrap Icons]({{ site.param icons }}) to create alerts with icons. Depending on your icons and content, you may want to add more utilities or custom styles.
...
- Add a [close button]({{ site.docsref "/components/close-button" }}) and the `.alert-dismissible` class, which adds extra padding to the right of the alert and positions the close button.
